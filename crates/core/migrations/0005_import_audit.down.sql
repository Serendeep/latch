CREATE TEMP TABLE import_audit_down_guard (allowed INTEGER CHECK(allowed=1));
INSERT INTO import_audit_down_guard SELECT NOT EXISTS(SELECT 1 FROM audit_events WHERE operation>=14);
DROP TABLE import_audit_down_guard;
